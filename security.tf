...
#######################
resource "aws_security_group_rule" "efs_fargate" {
  type                     = "ingress"
  from_port               = 2049
  to_port                 = 2049
  protocol                = "tcp"
  ...
  description = "NFS access from Fargate instances"
}

#######################
# Update MySQL Security Group
#######################
resource "aws_security_group_rule" "mysql_fargate" {
  type                     = "ingress"
  from_port               = 3306
  to_port                 = 3306
  protocol                = "tcp"
  ...
  description = "MySQL access from Fargate instances"
}
